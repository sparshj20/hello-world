      ...
      <section>
        ...
        <div>
          <ExperienceItem
            ...
            company="Blinkit"
            description="Building supply chain products — owns first mile operations, brand experience, and merchant payments."
          />
            ...
            roles={[
              {
                ...
                description: (
                  <>
                    ...
                    See <Link href="/work/reorder-discovery" className="text-link">case study</Link>.
                  </>
                ),
              },
              {
                ...
                years: "2021 – 2023",
                description:
                  "Pioneered India's first certified 3DS SDK — piloted with Swiggy and CRED, improving card success rates by 200 bps. Built split payments, spearheaded 3DS Server certification across Visa and Mastercard, and launched an in-house A/B platform. Reduced refund TAT from 2 hours to 5 minutes at peak 200 QPS.",
              },
            ]}
          />
            ...
            roles={[
              {
                ...
                description:
                  "Scaled payouts to 99.5% success rate and 1000 TPS. Conceptualised and delivered India's first RBI-selected cross-border payments MVP (RBI 2nd Cohort). Built fraud detection and AML checks for e-collect, and launched MVP of Banking as a Service — Accounts Suite.",
              },
              {
                title: "Product Analyst",
                years: "Feb – Sep 2020",
                description: "Analytics and product instrumentation across payout rails.",
              },
            ]}
          />
